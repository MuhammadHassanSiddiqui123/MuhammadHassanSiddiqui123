<h1>Muhammad Hassan Siddiqui</h1>

### Software Engineer | Machine Learning & Data Pipelines

*Specializing in End-to-End ML Systems, Automated Pipelines, and Serverless Deployment.*
...
**[Pearls AQI Predictor](https://github.com/MuhammadHassanSiddiqui123/aqi-predictor)** — a fully serverless system forecasting Karachi's Air Quality Index 3 days ahead. Hourly ingestion, daily retraining across 5 model architectures, SHAP explainability, and a live public dashboard — all running unattended on free-tier infrastructure.

- 🏆 Champion model: Ridge Regression, R² = 0.866 (1-day forecast)
- 🔗 [Live Dashboard](https://aqi-predictor-muuoitut5uarhwpuqey8kr.streamlit.app) &nbsp;|&nbsp; [Technical Report](https://github.com/MuhammadHassanSiddiqui123/aqi-predictor/tree/main/Documents)
...
<p>
  ...
  <img src="https://img.shields.io/badge/Hopsworks-1EB182?style=flat-square" />
